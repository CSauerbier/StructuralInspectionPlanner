...
void LineVisualization::visualizeLine(CartesianCoordinates start, CartesianCoordinates end)
{
    ros::NodeHandle n;
    ros::Publisher viewpoint_pub = n.advertise<visualization_msgs::Marker>("line_marker", 1);
    ...
    marker.header.frame_id = "kopt_frame";
    marker.header.stamp = ros::Time::now();
    marker.id = s_publishing_number+10000000;
    marker.ns = "Lines";
